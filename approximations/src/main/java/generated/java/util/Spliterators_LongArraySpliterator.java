...
public final class Spliterators_LongArraySpliterator implements Spliterator.OfLong {
    ...
    public Spliterators_LongArraySpliterator(long[] array, int index, int fence, int characteristics) {
        this.array = array;
        this.index = index;
        this.fence = fence;
    ...
    public void forEachRemaining(Consumer<? super Long> _action) {
        if (_action == null)
    ...
    public boolean tryAdvance(Consumer<? super Long> _action) {
        if (_action == null)
            throw new NullPointerException();
    ...
    public Spliterator.OfLong trySplit() {
        ...
        this.index = mid;
        return new Spliterators_LongArraySpliterator(this.array, lo, mid, this.characteristics);
    }
}
