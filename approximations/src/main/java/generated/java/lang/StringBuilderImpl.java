...
public final class StringBuilderImpl implements Serializable, Comparable<StringBuilderImpl>, CharSequence {
    ...
    public StringBuilderImpl(char[] value, int count) {
        this.value = value;
        this.count = count;
    }

    public StringBuilderImpl() {
        this(new char[STRING_BUILDER_LENGTH_MAX], 0);
    }

    public StringBuilderImpl(CharSequence seq) {
        if (seq == null)
            throw new NullPointerException();
        this.value = new char[STRING_BUILDER_LENGTH_MAX];
    ...
    public StringBuilderImpl append(char[] str) {
        _assumeInvariants();
    ...
    public StringBuilderImpl append(char[] str, int offset, int len) {
        _assumeInvariants();
        String seq = LibSLRuntime.toString(str);
    ...
    public IntStream chars() {
        ...
        return new IntStreamImpl(intValues, len, Engine.makeSymbolicList(), false, false);
    }
