...
public class RandomImpl implements Serializable {
    ...
    public DoubleStream doubles() {
        ...
        return new DoubleStreamImpl(items, LibSLGlobals.RANDOM_STREAM_SIZE_MAX, Engine.makeSymbolicList(), false, false);
    }
    ...
    public DoubleStream doubles(long streamSize) {
        ...
        return new DoubleStreamImpl(Engine.makeSymbolicDoubleArray(size), size, Engine.makeSymbolicList(), false, false);
    }
    ...
    public DoubleStream doubles(long streamSize, double randomNumberOrigin, double randomNumberBound) {
        ...
        return new DoubleStreamImpl(items, size, Engine.makeSymbolicList(), false, false);
    }

    public IntStream ints() {
        int[] items = Engine.makeSymbolicIntArray(LibSLGlobals.RANDOM_STREAM_SIZE_MAX);
        return new IntStreamImpl(items, LibSLGlobals.RANDOM_STREAM_SIZE_MAX, Engine.makeSymbolicList(), false, false);
    }
    ...
    public IntStream ints(long streamSize) {
        ...
        return new IntStreamImpl(items, size, Engine.makeSymbolicList(), false, false);
    }
    ...
    public LongStream longs() {
        ...
        return new LongStreamImpl(
            items,
            LibSLGlobals.RANDOM_STREAM_SIZE_MAX,
            Engine.makeSymbolicList(),
            false,
            false
        );
    }
    ...
    public LongStream longs(long streamSize) {
        ...
        return new LongStreamImpl(
            Engine.makeSymbolicLongArray(size),
            size,
            Engine.makeSymbolicList(),
            false,
            false
    ...
    public LongStream longs(long streamSize, long randomNumberOrigin, long randomNumberBound) {
        ...
        return new LongStreamImpl(
            _generateRandomLongArrayWithBounds(size, randomNumberOrigin, randomNumberBound),
            size,
            Engine.makeSymbolicList(),
            false,
            false
